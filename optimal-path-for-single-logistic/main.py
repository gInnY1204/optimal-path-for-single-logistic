...
def cal_travel_time_mat(locs):
    ...
    # planner
    planner = RoutingPlanner(1, 0, 0)   # get the shortest path
...
if __name__ == "__main__":
    ...
    planner = RoutingPlanner(1, 0, 0)
    visualization(planner, routes[0], 1, 0, 0)